                ...
                <form method="POST" id="contactform" onsubmit="return checkForm(this)" action="<?php echo get_template_directory_uri().'/sendcontact.php'?>">
                                ...
                                <div class="form-button">
                                        <div class="button-send">
                                            ...
                                            <div class="button-send-center left"><input name="contact_submit" type="submit" id="submit" class="emailsubmit"  tabindex="5" value="Submit" onclick="return checkForm(this)" /></div>
