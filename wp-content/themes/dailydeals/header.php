...
<?php 
   wp_deregister_script('jquery');
    ...
    <body <?php $class='body';
       body_class( $class ); ?> style="background-color: <?php echo $the_background?>">
        ...
        <div class="header">
            ...
            <div class="header-left">
                ...
                <div class="nav left">
                    <?php
                    	 if ( function_exists('has_nav_menu') && has_nav_menu('primary-menu') ) {
                             ...
                             ?>
                    <a class="log_in_link" href="<?php echo home_url()?>">Home</a>
                         <a class="log_in_link" href="<?php echo $all_deals_link?>">All Deals</a>
                ...
                <div class="header-right">
                    ...
                    if ( ($use_sendloop == 1 && $use_mailchimp == 1) ||  $use_sendloop == 1){
                        ...
                        <div class="search-header">
                            <div class="sidebar_widget_holder">
                                ...
                                <form action="http://<?php echo $sendloop_username ?>.sendloop.com/subscribe.php" method="post">
                                    ...
                                    <input type="submit" name="FormButton_Subscribe" value="Subscribe" id="FormButton_Subscribe" class="newsletter_button"/>
