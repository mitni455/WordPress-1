...
<div class="content">
    <div class="wrapper">
        ...
        <div class="content-background">
            ...
            $args=array('post_type' => 'deals', 'post_status' => 'publish','paged' => 0,'posts_per_page' => 10000,'ignore_sticky_posts'=> 1);
            ...
            if ( have_posts() ) : while ( have_posts() ) : the_post();
                    ...
                    ?>
                        ...
                        jQuery(document).ready(function(){
                                $('.all-deals-count-<?php echo $post_counter;?>').countdown({until: new Date(<?php echo $end_date[2]?>, <?php echo $end_date[0]?>-1, <?php echo $end_date[1]?>, <?php echo $matches[4]?>, <?php echo $matches[5]?>, <?php echo $matches[6]?>), layout: '{dn} days {hnn} hrs {mnn} min {snn} sec', compact: true, timezone:0});
                        })
                        </script>

                                <p class="all-deals-count-<?php echo $post_counter;?>"></p>
