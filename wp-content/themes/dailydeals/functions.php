...
function wpt_events_location() {
    ...
    // Get the location data if its already been entered
        ...
        $deal_image_1 = get_post_meta($post->ID+1, '_wp_attached_file', true);
        $deal_image_2 = get_post_meta($post->ID+2, '_wp_attached_file', true);
...
function save_meta_deal($post_id) {
		global $post, $meta_boxes_post, $meta_boxes_post_images, $meta_boxes_post_room, $meta_boxes_page, $key;
			...
			return $post_id;
                    ...
                    if($check_image_1 == false){
                        update_post_meta( $post_id+1, '_wp_attached_file', $upload_dir['baseurl'].'/'.$_POST[ 'deal_image_1'] );
                    }else{
                        update_post_meta( $post_id+1, '_wp_attached_file', $_POST[ 'deal_image_1'] );
                    }
                    }

                    else{
                        update_post_meta( $post_id+1, '_wp_attached_file', get_template_directory_uri().'/images/dummy/red.png' );
                    }
                    }
                    ...
                    if($check_image_2 == false){
                        update_post_meta( $post_id+2, '_wp_attached_file', $upload_dir['baseurl'].'/'.$_POST[ 'deal_image_2'] );
                    }else{
                        update_post_meta( $post_id+2, '_wp_attached_file', $_POST[ 'deal_image_2'] );
                    }
                    }
                    else{
                        update_post_meta( $post_id+2, '_wp_attached_file', get_template_directory_uri().'/images/dummy/red.png' );
                    }
                    }
...
$wpdb->query('INSERT INTO '.$table_name.'
    (txn_id, payment_date, payment_status, mc_currency, mc_gross, first_name, last_name, payer_email, custom, downloaded,post_ID, valid_date, test_ipn)
    VALUES ("'.$txn_id.'",
            "'.$payment_date.'",
            "'.$payment_status.'",
            "'.$payment_currency.'",
            ...
            // USER 1 DEALS
                ...
                if($dummy_1_exists == 0){
                 ...
                 $dummy_end_date = date('m/d/Y', $dummy_end_date);
                  ...
                  add_post_meta($dummy_deal_1_id, 'image_1', $dummy_deal_1_id+1);
                  add_post_meta($dummy_deal_1_id, 'image_2', $dummy_deal_1_id+2);
                  add_post_meta($dummy_deal_1_id+1, '_wp_attached_file', get_template_directory_uri().'/images/dummy/red.png');
                  add_post_meta($dummy_deal_1_id+2, '_wp_attached_file', get_template_directory_uri().'/images/dummy/red.png');
                }
            ...
            // USER 2 DEALS
                ...
                if($dummy_1_exists == 0){
                 ...
                 $dummy_end_date = date('m/d/Y', $dummy_end_date);
                  ...
                  add_post_meta($dummy_deal_2_id, 'image_1', $dummy_deal_1_id+1);
                  add_post_meta($dummy_deal_2_id, 'image_2', $dummy_deal_1_id+2);
                  add_post_meta($dummy_deal_2_id+1, '_wp_attached_file', get_template_directory_uri().'/images/dummy/red.png');
                  add_post_meta($dummy_deal_2_id+2, '_wp_attached_file', get_template_directory_uri().'/images/dummy/red.png');
                }
